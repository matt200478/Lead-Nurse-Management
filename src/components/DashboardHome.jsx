  ...
  return (
    <div className="p-6 md:p-10 max-w-7xl mx-auto min-h-full flex flex-col justify-center">
      <div className="mb-10 text-center">
        ...
        <p className="text-slate-500 font-medium max-w-2xl mx-auto">Select a module below to manage schedules, track staff compliance, and oversee daily clinic operations.</p>
      </div>
